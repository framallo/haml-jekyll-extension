...
This use the extension "jekyll_ext":http://github.com/rfelix/jekyll_ext.git which allows you to extend the Jekyll static blog generator without forking and modifying it’s codebase. 
